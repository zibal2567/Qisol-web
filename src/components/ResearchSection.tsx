  ...
  return (
    <section id="research" className="relative py-20 bg-gradient-to-br from-[#439b83]/20 via-[#367268]/15 to-[#2d5e53]/10 overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 sm:w-96 sm:h-96 bg-gradient-to-r from-[#2d5e53]/5 to-transparent rounded-full blur-3xl animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>
